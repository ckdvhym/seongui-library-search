...
const DEFAULTS={
 ...
 features:{browse:true,recommendations:true,searchSuggestions:true,relatedTopics:true,relatedBooks:true,newBooks:true,eventBanner:false},
